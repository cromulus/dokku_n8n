...
RUN set -eux; \
	...
	# rm -rf /root/.npm
RUN mkdir -p /home/node/.n8n/nodes && cd /home/node/.n8n/nodes && npm -i n8n-nodes-langchain n8n-nodes-carbonejs n8n-nodes-ldap n8n-nodes-ics-utils n8n-nodes-chatwoot n8n-nodes-document-generator n8n-nodes-text-manipulation
USER root
