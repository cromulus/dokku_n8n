...
RUN mkdir -p /tmp/n8n-nodes && cd /tmp/n8n-nodes && \
    pnpm install n8n-nodes-carbonejs n8n-nodes-chatwoot n8n-nodes-document-generator n8n-nodes-text-manipulation n8n-nodes-browser @digital-boss/n8n-nodes-google-pubsub n8n-nodes-logger n8n-nodes-advanced-flow n8n-nodes-webpage-content-extractor n8n-nodes-turndown-html-to-markdown n8n-nodes-keycloak n8n-nodes-globals @n8n-zengchao/n8n-nodes-browserless n8n-nodes-puppeteer-extended github:cromulus/n8n-nodes-twenty#ai-tools n8n-nodes-tweetnacl n8n-nodes-odata n8n-nodes-websockets-lite n8n-openapi-node n8n-nodes-mcp
